...
__global__
void cuda_GraphSum_forward_active(float *d_in_data, float *d_out_date, int *d_indptr, int *d_indices, int *in_degree,
                           int *outDegree, int dim, int localVertexSize, bool *active);

__global__
void cuda_GraphSum_forward(float *d_in_data, float *d_out_date, int *d_indptr, int *d_indices,
								 int *in_degree, int *outDegree, int dim, int localVertexSize);

__global__
void cuda_GraphSum_backward_active(float *d_in_grad, float *d_out_grad, int *d_indptr, int *d_indices, int *in_degree,
                            int *outDegree, int dim, int localVertexSize, bool *active);
